...
const LEVELS: LevelConfig[] = [
  { level: 1,  name: 'Apple Orchard',     fruitsToAdvance: 8,  spawnIntervalMs: 1400, bombChance: 0.03, goldenHeartChance: 0.008, heartChance: 0.025, slowMoChance: 0.04, peakHeightMin: 0.10, peakHeightMax: 0.16, gravity: 1000, burstCount: 1, horizontalDrift: 120, fruitRadius: 66, bombRadius: 46 },
  { level: 2,  name: 'Citrus Grove',      fruitsToAdvance: 10, spawnIntervalMs: 1300, bombChance: 0.05, goldenHeartChance: 0.008, heartChance: 0.025, slowMoChance: 0.04, peakHeightMin: 0.13, peakHeightMax: 0.20, gravity: 1000, burstCount: 1, horizontalDrift: 160, fruitRadius: 62, bombRadius: 44 },
  { level: 3,  name: 'Berry Patch',       fruitsToAdvance: 14, spawnIntervalMs: 1200, bombChance: 0.07, goldenHeartChance: 0.008, heartChance: 0.025, slowMoChance: 0.04, peakHeightMin: 0.16, peakHeightMax: 0.24, gravity: 1050, burstCount: 2, horizontalDrift: 200, fruitRadius: 58, bombRadius: 42 },
  { level: 4,  name: 'Tropical Paradise', fruitsToAdvance: 18, spawnIntervalMs: 1100, bombChance: 0.09, goldenHeartChance: 0.008, heartChance: 0.025, slowMoChance: 0.04, peakHeightMin: 0.20, peakHeightMax: 0.28, gravity: 1050, burstCount: 2, horizontalDrift: 240, fruitRadius: 54, bombRadius: 42 },
  { level: 5,  name: 'Fruit Storm',       fruitsToAdvance: 22, spawnIntervalMs: 1000, bombChance: 0.12, goldenHeartChance: 0.008, heartChance: 0.025, slowMoChance: 0.04, peakHeightMin: 0.24, peakHeightMax: 0.32, gravity: 1100, burstCount: 2, horizontalDrift: 280, fruitRadius: 50, bombRadius: 40 },
